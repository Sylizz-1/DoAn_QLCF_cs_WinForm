namespace DoAn_QLCF_cs_WinForm.View
{
	partial class NguyenLieuView
	{
		...
		private void InitializeComponent()
		{
			...
			tabControl1.Size = new Size(1019, 576);
			...
			listTabPage.Size = new Size(1011, 548);
			...
			label9.Location = new Point(1124, 13);
			label9.Name = "label9";
			...
			label2.Location = new Point(1294, 13);
			label2.Name = "label2";
			...
			comboBox2.Location = new Point(1178, 13);
			...
			comboBox1.Location = new Point(1370, 13);
			...
			editBtn.Location = new Point(1624, 9);
			...
			addBtn.Location = new Point(1497, 9);
			addBtn.Name = "addBtn";
			...
			dataGridView1.Size = new Size(1868, 800);
			...
			DetailsTabPage.Size = new Size(1011, 548);
			...
			HuyBtn.Location = new Point(1640, 865);
			HuyBtn.Name = "HuyBtn";
			...
			xacNhanBtn.Location = new Point(1487, 865);
